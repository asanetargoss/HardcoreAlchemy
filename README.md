...
* Currently requires, at minimum, [Metamorph](https://github.com/asanetargoss/metamorph/releases), [Nutrition](https://github.com/asanetargoss/Nutrition), [Wawla](https://minecraft.curseforge.com/projects/wawla-what-are-we-looking-at), and some sort of mod with a random respawn mechanic, such as [Iberia](https://github.com/asanetargoss/iberia/releases) or [Better with Mods](https://minecraft.curseforge.com/projects/better-with-mods). See the links provided, as some are required custom builds. (Note: Nutrition is actually not required, but requires a custom build or else your game will crash)
