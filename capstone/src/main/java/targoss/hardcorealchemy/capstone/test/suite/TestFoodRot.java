...
import static targoss.hardcorealchemy.capstone.test.HardcoreAlchemyTests.DEFAULT_CONFIGS;
...
import targoss.hardcorealchemy.capstone.test.api.UniqueFakePlayer;
...
public class TestFoodRot implements ITestSuite {
    ...
    public boolean hasInventoryChest() {
        TileEntityChest chest = new TileEntityChest();
        return InventoryExtension.INSTANCE.getInventories(chest).size() == 1;
    }
    ...
    public static boolean decayChestAtRate(float decayRate) {
        ...
        tickInventories(decayRate, InventoryExtension.INSTANCE.getInventories(chest));
    ...
    public boolean hasInventoryIronBackpack() {
        ...
        return InventoryExtension.INSTANCE.getInventories(backpackStack).size() == 1;
    }
    ...
    public boolean countPlayerInventories() {
        ...
        return InventoryExtension.INSTANCE.getInventories(player).size() == numInventories;
    }
    ...
    public boolean decayPlayerInventory() {
        ...
        tickInventories(InventoryExtension.INSTANCE.getInventories(player));
    ...
    public boolean checkSaveBackpackNbt() {
        ...
        ListenerInventoryExtension.Wrapper.IronBackpacks.saveIronBackpackNbtToItem(new InvWrapper(inventoryBackpack), backpackStack);
    ...
    public boolean decayBackpackInPlayerInventory() {
        ...
        ListenerInventoryExtension.Wrapper.IronBackpacks.saveIronBackpackNbtToItem(inventoryBackpack, backpackStack);
