...
public class InstinctEffectTemperedFlame extends InstinctEffect {
    ...
    public static void applyColdEffects(EntityPlayer player, float amplifier) {
        // TODO: Potion effects I guess. Severity/quantity depends on amplifier. Timer is probably the same regardless, probably short (10 seconds)
        // player.addPotionEffect(slowness)
        // player.addPotionEffect(weakness)
        // player.addPotionEffect(mining_fatigue)
        // player.addPotionEffect(slowness2)
    }

    protected static void consumeLesserHeat(EntityPlayer player) {
        // TODO: Chance to consume fire/lava source while NOT in Nether (may consume block if fire burns eternally on it)
    }
    ...
    protected static void exposeToHeat(EntityPlayer player, Data data) {
        // TODO: Message that the player did something good (but not good enough)
        data.coolingTime = 0;
    }
